...
public class MakeMyTrip {
		...
		public void seleniumPractiseBlogspotCalendar() throws Exception {
			...
			wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//p [@data-cy = 'departureDate']")));
		...
		public void selectDateCalendar(String calendarDay, String calendarMonth, String calendarYear) throws Exception {
			...
			String day = driver.findElement(By.className("font30 latoBlack")).getText();
			String month = driver.findElement(By.linkText("May")).getText();
			String year = driver.findElement(By.className("shortYear")).getText();
			System.out.println("The month and year is : " + month+ year);
			Thread.sleep(2000);
